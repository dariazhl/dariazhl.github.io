...
export default function BlogPage() {
  useEffect(() => {
    ...
    setMeta("description", "Writing on AI safety, interpretability, and the architecture of responsible machine learning systems — by Daria Zahaleanu, Senior AI Architect.");
              ...
              <Link href={`/blog/${post.slug}`}>
                <article className="group block border border-border/50 bg-card/20 hover:bg-card/70 hover:border-primary/30 transition-all duration-300 p-8 md:p-10 cursor-pointer">
                  ...
                  <div className="mt-6 pt-6 border-t border-border/30">
                    <span className="font-mono text-xs text-primary/70 uppercase tracking-widest group-hover:text-primary transition-colors">
                      Read article
                    </span>
                  </div>
                </article>
