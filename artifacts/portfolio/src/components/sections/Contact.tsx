  ...
  return (
    <Section id="contact" className="bg-primary/5 min-h-[70vh] flex items-center border-t border-border/50">
      <div className="max-w-4xl mx-auto w-full text-center space-y-12">
        ...
        >
          <a href="mailto:anadaria.zahaleanu@gmail.com" className="inline-block group">
        ...
        >
          <a href="#" className="text-muted-foreground hover:text-white transition-colors flex flex-col items-center gap-2 group">
